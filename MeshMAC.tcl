...
#$ns_ use-newtrace             ;
set tracefd     [open ./MeshMAC.tr w]
$ns_ trace-all $tracefd
if { "$val(nam)" == "MeshMAC.nam" } {
...
$ns_ at 0.6 	"$node_(10) sscs starCTtDevice  0 "		;
...
if { ("$val(traffic)" == "cbr") } {
	...
	$ns_ attach-agent $node_(6) $udp14
...
proc stop {} {
	...
	if { ("$val(nam)" == "MeshMAC.nam") && ("$hasDISPLAY" == "1") } {
		exec nam MeshMAC.nam &
	}
